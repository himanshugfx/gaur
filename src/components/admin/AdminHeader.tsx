            ...
            <div className="flex items-center justify-between h-16 lg:h-20 px-4 sm:px-8 lg:px-12 xl:px-16">
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden lg:block">
                        ...
                        <p className="text-xs text-gray-500 font-medium mt-0.5">Managing Harbigreen Admin Panel</p>
                    </div>

                    {/* Mobile title */}
                    <div className="lg:hidden">
                        <h2 className="text-base font-bold text-gray-900">Harbigreen</h2>
                    </div>
                </div>
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="hidden sm:block text-right mr-1">
                                <p className="font-bold text-gray-900 text-sm leading-tight">Admin User</p>
                                <p className="text-[10px] text-emerald-600 font-black uppercase tracking-widest mt-0.5">Online</p>
                            </div>
                            <div className="w-10 h-10 bg-green-800 rounded-xl flex items-center justify-center shadow-lg shadow-green-500/20 group-hover:scale-105 transition-transform">
                            ...
                            <>
                                ...
                                <div className="absolute right-0 z-20 mt-3 w-64 bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 py-2 overflow-hidden transform origin-top-right transition-all animate-in fade-in zoom-in-95 duration-200">
                                    <div className="px-5 py-4 border-b border-gray-100 bg-gray-50/50">
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">admin@harbigreen.com</p>
                                    </div>
                                    <div className="p-2 space-y-1">
                                        ...
                                        >
                                            <div className="w-8 h-8 rounded-lg bg-gray-100 group-hover:bg-emerald-100 text-gray-400 group-hover:text-emerald-600 flex items-center justify-center transition-colors">
