    ...
    return (
        <div className="flex flex-col">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gray-950">
                ...
                <div className="relative z-10 container mx-auto px-6 text-center text-white space-y-10">
                    <div className="animate-fade-in-up">
                        <span className="inline-block px-6 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-sm font-medium tracking-[0.2em] uppercase text-purple-100">
                            Excellence in Hospitality
                        </span>
                    </div>
                    <h1 className="text-6xl md:text-8xl font-serif font-bold leading-tight tracking-tight animate-fade-in-up delay-100">
                        Elevate Every <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-200 via-white to-purple-200 drop-shadow-sm">
                            Guest Moment
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8 animate-fade-in-up delay-300">
                        <Link
                            href="/products"
                            className="group px-10 py-5 bg-white text-gray-950 hover:bg-purple-50 rounded-full font-medium transition-all transform hover:scale-105 shadow-xl shadow-purple-900/10 flex items-center gap-2 text-lg"
                        >
                            View Collection
            ...
            <section className="py-32 bg-white relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-purple-50/50 -skew-x-12 translate-x-32 z-0"></div>
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
                        {[
                            ...
                            <div key={i} className="group p-10 rounded-3xl bg-white hover:bg-white border border-gray-100 hover:border-gray-200 hover:shadow-2xl hover:shadow-purple-900/5 transition-all duration-500">
            ...
            <section className="py-32 bg-gray-950 text-white overflow-hidden relative">
                ...
                <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
                    <div className="space-y-10 order-2 lg:order-1">
                        <div className="space-y-6">
                            <h2 className="text-5xl md:text-6xl font-serif font-bold leading-tight">
                                Curated for <br />
                                <span className="text-purple-300">Absolute Comfort</span>
                            </h2>
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            <div className="flex gap-4 items-start">
                                <div className="p-3 bg-white/5 rounded-xl text-purple-300"><Droplets size={24} /></div>
                                <div>
                            ...
                            <div className="flex gap-4 items-start">
                                <div className="p-3 bg-white/5 rounded-xl text-purple-300"><Wind size={24} /></div>
                                <div>
                        ...
                        <div className="pt-8">
                            <Link href="/products" className="inline-flex items-center gap-3 text-white border-b border-purple-400/50 pb-1 hover:text-purple-300 hover:border-purple-300 transition-all group text-lg">
                    ...
                    <div className="relative order-1 lg:order-2 h-[600px] w-full">
                        ...
                        {/* Decorative Circle */}
                        <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-purple-600/20 rounded-full blur-3xl z-0"></div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-purple-50">
                <div className="container mx-auto px-6 text-center max-w-4xl mx-auto">
                    <Star className="w-12 h-12 text-purple-600 mx-auto mb-8 fill-current" />
                    <blockquote className="text-3xl md:text-4xl font-serif font-medium text-gray-900 leading-snug mb-10">
                        "LuxeAmenities has completely elevated our guest satisfaction scores. Their attention to quality and design is unmatched in the industry."
                    </blockquote>
